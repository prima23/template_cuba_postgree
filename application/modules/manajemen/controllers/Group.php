        ...
        if (!$this->input->is_ajax_request()) {
            ...
            if (isset($session)) {
                ...
                foreach ($dataList as $key => $dl) {
                    ...
                    $row = array();
                    $row[] = '
                    <button type="button" class="btn btn-success mb-1 btn-sm px-2 py-1 my-0 mx-0 waves-effect waves-light btnPrivilage" data-id="' . $this->encryption->encrypt($dl['id_group']) . '" title="Setting Privilege"><i class="fa fa-spin fa-cog fa-lg"></i></button>
                    <button type="button" class="btn btn-primary mb-1 btn-sm px-2 py-1 my-0 mx-0 waves-effect waves-light btnEdit" data-id="' . $this->encryption->encrypt($dl['id_group']) . '" title="Edit data"><i class="fa fa-pencil-square fa-lg"></i></button>
                    <button type="button" class="btn btn-danger mb-1 btn-sm px-2 py-1 my-0 mx-0 waves-effect waves-light btnDelete" data-id="' . $this->encryption->encrypt($dl['id_group']) . '" title="Hapus data"><i class="fa fa-trash-o fa-lg"></i></button>
                    ';
                    $row[] = $no;
                    $row[] = $dl['nama_group'];
